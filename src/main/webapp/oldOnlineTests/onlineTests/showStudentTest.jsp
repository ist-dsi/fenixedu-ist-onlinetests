	...
	<logic:iterate id="subQuestion" name="testQuestion" property="studentSubQuestions" type="org.fenixedu.academic.domain.onlineTests.SubQuestion" indexId="itemIndex">
		...
		<logic:iterate id="questionPresentation" name="subQuestion" property="prePresentation">
			...
			<%if (((String)questionLabel).startsWith("image/")){%>
				...
				<logic:equal name="correctionType" value="studentCorrection">
					<html:img bundle="HTMLALT_RESOURCES" altKey="img.img" align="absmiddle" src="<%= request.getContextPath() + "/oldOnlineTests/testsManagement.do?method=showImage&amp;testCode="+testCode.toString()+"&amp;exerciseCode="+ questionCode+"&amp;studentCode="+ studentId+"&amp;imgCode="+index.toString() +"&amp;imgType="+questionLabel.toString()+"&amp;item="+item.toString()%>"/>
				</logic:equal>
				<logic:notEqual name="correctionType" value="studentCorrection">
					<html:img bundle="HTMLALT_RESOURCES" altKey="img.img" align="absmiddle" src="<%= request.getContextPath() + "/oldOnlineTests/testsManagement.do?method=showImage&amp;testCode="+testCode.toString()+"&amp;exerciseCode=" + questionCode+"&amp;imgCode="+index.toString() +"&amp;imgType="+questionLabel.toString()+"&amp;item="+item.toString()%>"/>
				</logic:notEqual>
		...
		<logic:iterate id="questionBody" name="subQuestion" property="presentation">
			...
			<%if (((String)questionLabel).startsWith("image/")){%>
				<bean:define id="index" value="<%= (new Integer(Integer.parseInt(index)+1)).toString() %>"/>
				<logic:equal name="correctionType" value="studentCorrection">
					<html:img align="absmiddle" src="<%= request.getContextPath() + "/oldOnlineTests/testsManagement.do?method=showImage&amp;testCode="+testCode.toString()+"&amp;exerciseCode="+ questionCode+"&amp;studentCode="+ studentId +"&amp;imgCode="+index.toString() +"&amp;imgType="+questionLabel.toString()+"&amp;item="+item.toString()%>" altKey="questionLabel" bundle="IMAGE_RESOURCES"/>
				</logic:equal>
				<logic:notEqual name="correctionType" value="studentCorrection">
					<html:img align="absmiddle" src="<%= request.getContextPath() + "/oldOnlineTests/testsManagement.do?method=showImage&amp;testCode="+testCode.toString()+"&amp;exerciseCode=" + questionCode+"&amp;imgCode="+index.toString() +"&amp;imgType="+questionLabel.toString()+"&amp;item="+item.toString()%>" altKey="questionLabel" bundle="IMAGE_RESOURCES"/>
				</logic:notEqual>
				<logic:equal name="imageLabel" value="true">
					</td><td>
				</logic:equal>
			...
			<logic:notEqual name="pageType" value="doTest">
				<logic:notEqual name="correctionAvailability" value="1">
					<logic:equal name="imsFeedback" value="true">
						...
						<logic:notEmpty name="subQuestion" property="unansweredResponseProcessingInstructionIndex">
							<bean:define id="responseProcessingIndex" name="subQuestion" property="unansweredResponseProcessingInstructionIndex"/>
						</logic:notEmpty>
						<logic:notEmpty name="testQuestion" property="response">
							<logic:notEmpty name="testQuestion" property="response.response">
						...
						<logic:notEmpty name="responseProcessingIndex">		
							<logic:notEmpty name="subQuestion" property="responseProcessingInstructions">
								<logic:notEmpty name="subQuestion" property='<%="responseProcessingInstructions["+responseProcessingIndex+"].feedback"%>'>
									<logic:iterate id="feedback" name="subQuestion" property='<%="responseProcessingInstructions["+responseProcessingIndex+"].feedback"%>'>
										...
										<%if (((String)feedbackLabel).startsWith("image/")){%>
											<bean:define id="index" value="<%= (new Integer(Integer.parseInt(index)+1)).toString() %>"/>
											<logic:equal name="correctionType" value="studentCorrection">
												<html:img align="absmiddle" src="<%= request.getContextPath() + "/oldOnlineTests/testsManagement.do?method=showImage&amp;testCode="+testCode.toString()+"&amp;exerciseCode="+ questionCode +"&amp;studentCode="+ studentId +"&amp;imgCode="+index.toString()+"&amp;feedbackCode="+responseProcessingIndex.toString()+"&amp;imgType="+feedbackLabel.toString()+"&amp;item="+item.toString()%>" altKey="feedbackLabel" bundle="IMAGE_RESOURCES"/>
											</logic:equal>
											<logic:notEqual name="correctionType" value="studentCorrection">
												<html:img align="middle" src="<%= request.getContextPath() + "/oldOnlineTests/testsManagement.do?method=showImage&amp;testCode="+testCode.toString()+"&amp;exerciseCode="+ questionCode +"&amp;imgCode="+index.toString() +"&amp;feedbackCode="+responseProcessingIndex.toString() +" &amp;imgType="+feedbackLabel.toString()+"&amp;item="+item.toString()%>" altKey="feedbackLabel" bundle="IMAGE_RESOURCES"/>
											</logic:notEqual>
											<logic:equal name="imageLabel" value="true">
												</td><td>
											</logic:equal>
