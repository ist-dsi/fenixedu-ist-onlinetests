 ...
 */
@StrutsFunctionality(bundle = "ApplicationResources", titleKey = "title.showTests", path = "online-tests",
        app = TeacherTeachingApp.class)
@Mapping(path = "/testsManagement", module = "oldOnlineTests", formBean = "testForm")
@Forward(name = "chooseCourse", path = "/oldOnlineTests/onlineTests/chooseCourse.jsp")
public class TestsManagementAction extends ExecutionCourseBaseAction {
    ...
    private ActionForward doForward(HttpServletRequest request, String testsPath) {
        request.setAttribute("teacher$actual$page", "/oldOnlineTests/onlineTests/" + testsPath + ".jsp");
        return new ActionForward("/onlineTests/testsFrame.jsp");
    }

    @EntryPoint
    public ActionForward chooseCourse(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    public ActionForward distributeTest(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        final String path =
                request.getContextPath()
                        + "/oldOnlineTests/testDistribution.do?method=showDistributedTests&amp;executionCourseID="
                        + executionCourseID;
